...
80105283:	e8 98 1b 00 00       	call   80106e20 <shm_close>
}
80105288:	c9                   	leave  
80105289:	c3                   	ret    
...
80106d22:	eb 13                	jmp    80106d37 <shm_open+0x47>
80106d24:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
     mappages(myproc()->pgdir,(char*)size,PGSIZE,va,PTE_W|PTE_U);
     shm_table.shm_pages[i].refcnt++;
     break;
   }
   else{
     if(shm_table.shm_pages[i].id == 0){
80106d28:	85 d2                	test   %edx,%edx
80106d2a:	74 7c                	je     80106da8 <shm_open+0xb8>
 for(i = 0; i < 64; i++){
80106d2c:	83 c0 01             	add    $0x1,%eax
80106d2f:	83 c1 0c             	add    $0xc,%ecx
80106d32:	83 f8 40             	cmp    $0x40,%eax
80106d35:	74 47                	je     80106d7e <shm_open+0x8e>
   if(shm_table.shm_pages[i].id == id){
80106d37:	8b 11                	mov    (%ecx),%edx
80106d39:	39 da                	cmp    %ebx,%edx
80106d3b:	75 eb                	jne    80106d28 <shm_open+0x38>
     va = V2P(shm_table.shm_pages[i].frame);
80106d3d:	8d 1c 40             	lea    (%eax,%eax,2),%ebx
80106d40:	c1 e3 02             	shl    $0x2,%ebx
80106d43:	8b 83 f8 54 11 80    	mov    -0x7feeab08(%ebx),%eax
80106d49:	8d b8 00 00 00 80    	lea    -0x80000000(%eax),%edi
     mappages(myproc()->pgdir,(char*)size,PGSIZE,va,PTE_W|PTE_U);
80106d4f:	e8 5c c9 ff ff       	call   801036b0 <myproc>
80106d54:	c7 44 24 10 06 00 00 	movl   $0x6,0x10(%esp)
80106d5b:	00 
80106d5c:	89 7c 24 0c          	mov    %edi,0xc(%esp)
80106d60:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80106d67:	00 
80106d68:	89 74 24 04          	mov    %esi,0x4(%esp)
80106d6c:	8b 40 04             	mov    0x4(%eax),%eax
80106d6f:	89 04 24             	mov    %eax,(%esp)
80106d72:	e8 d9 f7 ff ff       	call   80106550 <mappages>
     shm_table.shm_pages[i].refcnt++;
80106d77:	83 83 fc 54 11 80 01 	addl   $0x1,-0x7feeab04(%ebx)
       break;
     }
   }
 }
...
80106d7e:	e8 2d c9 ff ff       	call   801036b0 <myproc>
80106d83:	8b 10                	mov    (%eax),%edx
80106d85:	8b 45 0c             	mov    0xc(%ebp),%eax
80106d88:	89 10                	mov    %edx,(%eax)
 myproc()->sz ++;
80106d8a:	e8 21 c9 ff ff       	call   801036b0 <myproc>
80106d8f:	83 00 01             	addl   $0x1,(%eax)
 release(&(shm_table.lock));
80106d92:	c7 04 24 c0 54 11 80 	movl   $0x801154c0,(%esp)
80106d99:	e8 a2 d4 ff ff       	call   80104240 <release>
...
80106da8:	8d 3c 40             	lea    (%eax,%eax,2),%edi
80106dab:	c1 e7 02             	shl    $0x2,%edi
80106dae:	89 9f f4 54 11 80    	mov    %ebx,-0x7feeab0c(%edi)
       shm_table.shm_pages[i].frame = kalloc();
80106db4:	e8 f7 b6 ff ff       	call   801024b0 <kalloc>
       memset(shm_table.shm_pages[i].frame,0,PGSIZE);
80106db9:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80106dc0:	00 
80106dc1:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80106dc8:	00 
       shm_table.shm_pages[i].refcnt++;
80106dc9:	83 87 fc 54 11 80 01 	addl   $0x1,-0x7feeab04(%edi)
       memset(shm_table.shm_pages[i].frame,0,PGSIZE);
80106dd0:	89 04 24             	mov    %eax,(%esp)
       shm_table.shm_pages[i].frame = kalloc();
80106dd3:	89 87 f8 54 11 80    	mov    %eax,-0x7feeab08(%edi)
       memset(shm_table.shm_pages[i].frame,0,PGSIZE);
80106dd9:	e8 b2 d4 ff ff       	call   80104290 <memset>
       va = V2P(shm_table.shm_pages[i].frame);
80106dde:	8b 9f f8 54 11 80    	mov    -0x7feeab08(%edi),%ebx
       mappages(myproc()->pgdir,(char*)size,PGSIZE,va,PTE_W|PTE_U);
80106de4:	e8 c7 c8 ff ff       	call   801036b0 <myproc>
80106de9:	c7 44 24 10 06 00 00 	movl   $0x6,0x10(%esp)
80106df0:	00 
80106df1:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80106df8:	00 
       va = V2P(shm_table.shm_pages[i].frame);
80106df9:	81 c3 00 00 00 80    	add    $0x80000000,%ebx
       mappages(myproc()->pgdir,(char*)size,PGSIZE,va,PTE_W|PTE_U);
80106dff:	89 5c 24 0c          	mov    %ebx,0xc(%esp)
80106e03:	89 74 24 04          	mov    %esi,0x4(%esp)
80106e07:	8b 40 04             	mov    0x4(%eax),%eax
80106e0a:	89 04 24             	mov    %eax,(%esp)
80106e0d:	e8 3e f7 ff ff       	call   80106550 <mappages>
       break;
80106e12:	e9 67 ff ff ff       	jmp    80106d7e <shm_open+0x8e>
...
80106e27:	8b 5d 08             	mov    0x8(%ebp),%ebx
//you write this too!
acquire(&(shm_table.lock));
80106e2a:	c7 04 24 c0 54 11 80 	movl   $0x801154c0,(%esp)
80106e31:	e8 1a d3 ff ff       	call   80104150 <acquire>
80106e36:	b8 f4 54 11 80       	mov    $0x801154f4,%eax
80106e3b:	eb 0d                	jmp    80106e4a <shm_close+0x2a>
80106e3d:	8d 76 00             	lea    0x0(%esi),%esi
80106e40:	83 c0 0c             	add    $0xc,%eax
int i;
for(i = 0 ; i < 64; i++){
80106e43:	3d f4 57 11 80       	cmp    $0x801157f4,%eax
80106e48:	74 36                	je     80106e80 <shm_close+0x60>
        if(shm_table.shm_pages[i].id == id){
80106e4a:	3b 18                	cmp    (%eax),%ebx
80106e4c:	75 f2                	jne    80106e40 <shm_close+0x20>
		shm_table.shm_pages[i].refcnt--;
80106e4e:	8b 48 08             	mov    0x8(%eax),%ecx
80106e51:	8d 51 ff             	lea    -0x1(%ecx),%edx
              if(shm_table.shm_pages[i].refcnt == 0){
80106e54:	85 d2                	test   %edx,%edx
		shm_table.shm_pages[i].refcnt--;
80106e56:	89 50 08             	mov    %edx,0x8(%eax)
              if(shm_table.shm_pages[i].refcnt == 0){
80106e59:	75 e5                	jne    80106e40 <shm_close+0x20>
			shm_table.shm_pages[i].id = 0;
80106e5b:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
80106e61:	83 c0 0c             	add    $0xc,%eax
    			shm_table.shm_pages[i].frame = 0;
80106e64:	c7 40 f8 00 00 00 00 	movl   $0x0,-0x8(%eax)
			shm_table.shm_pages[i].refcnt = 0;
80106e6b:	c7 40 fc 00 00 00 00 	movl   $0x0,-0x4(%eax)
for(i = 0 ; i < 64; i++){
80106e72:	3d f4 57 11 80       	cmp    $0x801157f4,%eax
80106e77:	75 d1                	jne    80106e4a <shm_close+0x2a>
...
release(&(shm_table.lock));
80106e80:	c7 04 24 c0 54 11 80 	movl   $0x801154c0,(%esp)
80106e87:	e8 b4 d3 ff ff       	call   80104240 <release>



return 0; //added to remove compiler warning -- you should decide what to return
}
80106e8c:	83 c4 14             	add    $0x14,%esp
